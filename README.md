...
`playlist4whisper` manages media stream playlists, plays media, creates `.srt` subtitle files from local media files, and transcribes live video/audio streams using AI. It includes configurable time-shift, multi-instance/multi-user support, translation, and Text-to-Speech functionality.
