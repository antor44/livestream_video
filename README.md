...
- On very old computers, it is possible to generate subtitles with the larger models; the only limiting factor will be the time it takes. On the other hand, with a powerful CPU, or with a GPU/NPU and a special version of whisper.cpp, the subtitles will be generated very quickly.
