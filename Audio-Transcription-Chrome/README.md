# Audio Transcription for Chrome/Chromium/Microsoft Edge 1.7.0
...
**Q: Some transcribed texts are difficult to read when words keep changing, and some phrases disappear o appear to be cut off. Why is that?**
