...
function init_element() {
    ...
    elem_container.style.cssText = 'padding-top:4px;font-size:20px;line-height:18px;position:fixed;top:92%;left:38%;transform:translate(-50%,-50%);width:1000px;height:110px;opacity:1;z-index:100;background:black;border-radius:10px;color:white;';
